...
import 'info_pages.dart'; // اضافه کنید
...
class ProfileScreen extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // اضافه شدن ناوبری به صفحات جدید
            _buildMenuItem(
              context, 
            ...
            const SizedBox(height: 8),
            _buildMenuItem(context, icon: Icons.group_outlined, title: 'دعوت از دوستان', onTap: () {}),
            const Spacer(),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Directionality(
          textDirection: TextDirection.rtl, // اجبار راست‌چین بودن محتوای داخل ردیف
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              // آیکون و عنوان سمت راست
              Row(
                children: [
                  Icon(icon, color: color),
                  const SizedBox(width: 12),
                  Text(title, style: TextStyle(fontFamily: 'Peyda', fontWeight: FontWeight.w500, color: color)),
                ],
              ),
              // فلش سمت چپ
  ...
  void _handlePasswordTap(BuildContext context) async {
    ...
    if (hasPassword) {
      _showPasswordOptionsSheet(context);
    } else {
